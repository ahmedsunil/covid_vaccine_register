            ...
            <form action="{{ route('patients.store') }}" method="POST">
                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="text" name="case_id" id="case_id" autocomplete="given-case_id" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('case_id') border-red-500 @enderror" placeholder="eg: 00091111" value="{{ old('case_id') }}">
                        @error('case_id')
                            <div class="alert alert-danger text-sm text-red-800 p-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="number" name="contact" id="contact" autocomplete="given-contact" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('contact') border-red-500 @enderror" placeholder="eg: 7626626" value="{{ old('contact') }}">
                        @error('contact')
                        <div class="alert alert-danger text-sm text-red-800 p-1">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="text" name="nationality" id="nationality" autocomplete="given-nationality" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('nationality') border-red-500 @enderror" placeholder="Maldivian" value="{{ old('nationality') }}">
                        @error('nationality')
                        <div class="alert alert-danger text-sm text-red-800 p-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="text" name="current_address" id="current_address" autocomplete="given-current_address" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('current_address') border-red-500 @enderror" placeholder="Marine Villa / R.Hulhudhuffaaru" value="{{ old('current_address') }}">
