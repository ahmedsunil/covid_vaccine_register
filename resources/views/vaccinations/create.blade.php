            ...
            <form action="{{ route('vaccinations.store') }}" method="POST">
                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="date" name="date_for_vaccination" id="date_for_vaccination" autocomplete="given-date_for_vaccination" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('date_for_vaccination') border-red-500 @enderror" value="{{ old('date_for_vaccination') }}">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="text" name="remarks" id="remarks" autocomplete="given-remarks" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('remarks') border-red-500 @enderror" placeholder="eg: Alergies etc" value="{{ old('remarks') }}">
                        @error('remarks')
                            <div class="alert alert-danger text-sm text-red-800 p-1">{{ $message }}</div>
                        @enderror
                    </div>
